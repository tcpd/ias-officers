...
dataset_dir = r"H:/My Drive/python_sync/TCPD/ias-release"
...
for id in tqdm(profile_data["ID"]):
    main_data[id] = {
        ...
        "Service": profile_data[profile_data["ID"] == id]["Service"].values[0],
...
with open(dataset_dir + "/ias-release-new.json", "w") as f:
